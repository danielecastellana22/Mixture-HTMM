function [classId,treeString] = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   [CLASSID,TREESTRING] = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   [CLASSID,TREESTRING] = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   [classId,treeString] = importfile('inex05.test.elastic.tree',1, 4811);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/09/16 17:58:38
